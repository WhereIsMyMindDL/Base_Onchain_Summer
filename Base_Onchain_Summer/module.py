...
class Onchain_Summer(Account):
    ...
    def Truworld_Onchain_Summer_Pass(self):
        Onchain_Summer.do_quest(self,
                                challengeId='ocsChallenge_b00cf94a-51aa-4359-abf7-2cada197d0ca',
                                name='Truworld Onchain Summer Pass',
                                to='0xf2b0F524e754217905f043A0759d594DA892A59e',
                                value=0,
                                data=f'0x57bc3d78000000000000000000000000{self.address[2:]}')
        return self.send_list
    
    def Forbes_Web3_INSPIRE(self):
        Onchain_Summer.do_quest(self,
                                challengeId='ocsChallenge_b3f47fc6-3649-4bad-9e10-7244fbe1d484',
                                name='Forbes Web3 INSPIRE',
                                to='0x0821D16eCb68FA7C623f0cD7c83C8D5Bd80bd822',
                                value=0,
                                data=f'0x84bb1e42000000000000000000000000{self.address[2:]}')
        return self.send_list
